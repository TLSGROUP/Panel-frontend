...
interface BillingTableRow extends BillingHistoryItem {}
interface WithdrawalTableRow extends WithdrawalRequest {}
...
export default function BillingPage() {
  ...
  const historyTableConfig = useMemo(
    () => ({
      ...
      enableExport: false,
      enableToolbar: true,
      columnResizingTableId: "billing-history-dashboard",
  ...
  const withdrawalsTableConfig = useMemo(
    () => ({
      ...
      enableExport: false,
      enableToolbar: true,
      columnResizingTableId: "billing-withdrawals-dashboard",
      defaultSortBy: "createdAt",
      defaultSortOrder: "desc" as const,
    }),
    []
