...
const TOOLBAR_TEXT_CLASS = "text-xs leading-4";
const TOOLBAR_INPUT_CLASS = "text-sm leading-5 placeholder:text-sm";
...
export function DataTableToolbar<TData extends ExportableData>({
  ...
  return (
    <div className={`flex flex-wrap items-center justify-between ${TOOLBAR_TEXT_CLASS}`}>
      <div className="flex flex-1 flex-wrap items-center gap-2">
        {config.enableSearch && (
          <Input
            ...
            className={`w-[150px] lg:w-[250px] ${getInputSizeClass(config.size)} ${TOOLBAR_INPUT_CLASS}`}
          />
        )}
        ...
        {config.enableDateFilter && (
          <div className="flex items-center">
            <CalendarDatePicker
              ...
              className={`w-fit cursor-pointer ${getInputSizeClass(config.size)} ${TOOLBAR_TEXT_CLASS}`}
              variant="outline"
            />
          </div>
        )}
        ...
        {isFiltered && (
          <Button
            ...
            className={`${getButtonSizeClass(config.size)} ${TOOLBAR_TEXT_CLASS}`}
          >
            Reset
