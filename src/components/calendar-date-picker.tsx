  ...
  <DropdownMenu modal={false}>
    <DropdownMenuTrigger asChild>
      <Button
        variant="outline"
        size="sm"
        className="w-[122px] h-9 justify-between font-medium hover:bg-accent hover:text-accent-foreground"
      >
    ...
    <DropdownMenuContent
      ...
      className="rounded-lg border border-white/10 bg-black/40 text-white backdrop-blur-md max-h-[300px]"
    >
      <DropdownMenuRadioGroup
        value={value ?? ""}
        ...
        <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
          <PopoverTrigger asChild>
            <Button
              ...
              {...props}
              className={cn(
                "w-auto border border-emerald-500 bg-transparent text-emerald-500 transition hover:bg-emerald-500/10 hover:text-white",
                className
              )}
              size="default"
          ...
          {isPopoverOpen && (
            <PopoverContent
              className="w-auto rounded-lg border border-white/10 bg-black/40 backdrop-blur-md max-h-[var(--radix-popover-content-available-height)] overflow-y-auto"
              align="start"
              avoidCollisions={true}
