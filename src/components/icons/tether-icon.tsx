...
export function TetherIcon({ className }: TetherIconProps) {
  return (
    <svg
      viewBox="-.22340448 -.01226007 339.87680896 295.51831992"
      className={cn("h-4 w-4", className)}
      aria-hidden="true"
    >
      <g fillRule="evenodd">
        <path
          d="m62.15 1.45-61.89 130a2.52 2.52 0 0 0 .54 2.94l167.15 160.17a2.55 2.55 0 0 0 3.53 0l167.15-160.16a2.52 2.52 0 0 0 .54-2.94l-61.89-130a2.5 2.5 0 0 0 -2.28-1.46h-210.55a2.5 2.5 0 0 0 -2.3 1.45z"
          fill="#50af95"
        />
        <path
